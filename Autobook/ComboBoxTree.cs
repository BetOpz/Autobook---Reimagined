...
namespace Autobook
{
    ...
    public event TreeViewEventHandler AfterSelect;
      ...
      this.tvTreeView.Height = 500;
      this.tvTreeView.AfterSelect += new TreeViewEventHandler (tvTreeView_AfterSelect);
    ...
    void tvTreeView_AfterSelect (object sender, TreeViewEventArgs e)
    {
      if (AfterSelect != null)
        AfterSelect (tvTreeView, e);
    }
    ...
    public void ExpandAll ()
    {
      tvTreeView.ExpandAll ();
		...
		public void TreeViewNodeSelect(object sender, EventArgs e) 
		{
